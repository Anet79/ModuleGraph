...
public class GraphView extends View {
    ...
    private void getAttrsFromTypedArray(AttributeSet attributeSet) {
        final TypedArray typedArray = getContext().obtainStyledAttributes(attributeSet, R.styleable.graphView, 0, 0);


        borderColor = typedArray.getColor(R.styleable.graphView_border_color, getResources().getColor(R.color.graph_border));
        strokeAnimDuration = typedArray.getInt(R.styleable.graphView_border_anim_duration, 1000);
    ...
    private void init() {
        ...
        @SuppressLint("ObjectAnimatorBinding") ObjectAnimator animator = ObjectAnimator.ofFloat(this, "phase", 1.0f, 0.0f);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        height = measureDimension(GraphView.convertDpToPixel(16, contextWeakReference.get()), heightMeasureSpec);
